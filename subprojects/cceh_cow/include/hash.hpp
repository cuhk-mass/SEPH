#ifndef CCEH_COW_HASH_H
#define CCEH_COW_HASH_H
/*
...
inline size_t constant(const void *key, size_t len, size_t seed = 0xc70697UL) {
    return 0;
}

inline static size_t (*hash_funcs[])(const void *key, size_t len,
                                     size_t seed) = {standard, murmur2, jenkins,
                                                     xxhash, constant};
